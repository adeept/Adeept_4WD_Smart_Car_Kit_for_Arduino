...
controlP5.Button drift_front_left;
controlP5.Button drift_front_right;
controlP5.Button drift_left;
controlP5.Button drift_right;
controlP5.Button drift_rear_left;
controlP5.Button drift_rear_right;
...
void setup() {
  ...
  drift_front_left = cp5.addButton("Drift_FL")
                        .setPosition(10, 10)
                        .setSize(90, 60);
  drift_front_left.getCaptionLabel()
                  .setFont(font)
                  .setSize(15)
                  .toUpperCase(false)
                  .setText("Drift_FL");
  
  drift_front_right = cp5.addButton("Drift_FR")
                          .setPosition(210, 10)
                          .setSize(90, 60);
  drift_front_right.getCaptionLabel()
                  .setFont(font)
                  .setSize(15)
                  .toUpperCase(false)
                  .setText("Drift_FR");
    
  drift_left = cp5.addButton("Drift_L")
                  .setPosition(10, 150)
                  .setSize(90, 60);
  drift_left.getCaptionLabel()
            .setFont(font)
            .setSize(15)
            .toUpperCase(false)
            .setText("Drift_L");
            
  drift_right = cp5.addButton("Drift_R")
                  .setPosition(210, 150)
                  .setSize(90, 60);
  drift_right.getCaptionLabel()
            .setFont(font)
            .setSize(15)
            .toUpperCase(false)
            .setText("Drift_R");
    
  drift_rear_left = cp5.addButton("Drift_RL")
                      .setPosition(10, 220)
                      .setSize(90, 60);
  drift_rear_left.getCaptionLabel()
                .setFont(font)
                .setSize(15)
                .toUpperCase(false)
                .setText("Drift_RL");
    
  drift_rear_right = cp5.addButton("Drift_RR")
                        .setPosition(210, 220)
                        .setSize(90, 60);
  drift_rear_right.getCaptionLabel()
                  .setFont(font)
                  .setSize(15)
                  .toUpperCase(false)
                  .setText("Drift_RR");
...
void draw() {
  ...
  textSize(70);
  fill(169, 169, 169);
  text("4WD Mecanum Car Robot GUI", 350, 100);
...
void mouseCheck(){
  ...
  if(drift_front_left.isPressed()){
    myClient.write("drift_front_left");
    delay(90); 
    myClient.write("DRS");
  }   
  if(drift_front_right.isPressed()){
    myClient.write("drift_front_right");
    delay(90); 
    myClient.write("DRS");
  }   
  if(drift_left.isPressed()){
    myClient.write("drift_left");
    delay(90); 
    myClient.write("DRS");
  }   
  if(drift_right.isPressed()){
    myClient.write("drift_right");
    delay(90); 
    myClient.write("DRS");
  }   
  if(drift_rear_left.isPressed()){
    myClient.write("drift_rear_left");
    delay(90); 
    myClient.write("DRS");
  }   
  if(drift_rear_right.isPressed()){
    myClient.write("drift_rear_right");
    delay(90); 
    myClient.write("DRS");
  }   
...
void buttonColor(){
  ...
  if(keyPressed && key=='z'){
    drift_front_left.setColorBackground(color(255,0,0));
    myClient.write("drift_front_left");
    delay(100);
    myClient.write("DRS");
  }
  else{
    drift_front_left.setColorBackground(color(2,72,90));
  }
  
  if(keyPressed && key=='x'){
    drift_front_right.setColorBackground(color(255,0,0));
    myClient.write("drift_front_right");
    delay(100);
    myClient.write("DRS");
  }
  else{
    drift_front_right.setColorBackground(color(2,72,90));
  }
  
  if(keyPressed && key=='c'){
    drift_left.setColorBackground(color(255,0,0));
    myClient.write("drift_left");
    delay(100);
    myClient.write("DRS");
  }
  else{
    drift_left.setColorBackground(color(2,72,90));
  }
  
  if(keyPressed && key=='v'){
    drift_right.setColorBackground(color(255,0,0));
    myClient.write("drift_right");
    delay(100);
    myClient.write("DRS");
  }
  else{
    drift_right.setColorBackground(color(2,72,90));
  }
  
  if(keyPressed && key=='b'){
    drift_rear_left.setColorBackground(color(255,0,0));
    myClient.write("drift_rear_left");
    delay(100);
    myClient.write("DRS");
  }
  else{
    drift_rear_left.setColorBackground(color(2,72,90));
  }
  
  if(keyPressed && key=='n'){
    drift_rear_right.setColorBackground(color(255,0,0));
    myClient.write("drift_rear_right");
    delay(100);
    myClient.write("DRS");
  }
  else{
    drift_rear_right.setColorBackground(color(2,72,90));
  }
